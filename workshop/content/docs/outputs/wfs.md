...
In this exercise we'll create a Mapfile to serve data as a WFS.
We'll be using the "Populated Places" from [Natural Earth](https://www.naturalearthdata.com/) as the data source.
